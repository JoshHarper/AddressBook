...
public class AddressBookUI extends UI {
    ...
    private void initSearch() {
        ...
        /*
         * We want to show a subtle prompt in the search field. We could also set a caption that
         * would be shown above the field or description to be shown in a tooltip.
         */
        ...
        /*
         * When the event happens, we handle it in the anonymous inner class.  You may choose to
         * use separate controllers (in MVC) or presenters (in MVP) instead. In the end, the
         * preferred application architecture is up to you.
         */
    ...
    /*
     * A custom filter for searching names and companies in the contactContainer.
     */
    ...
    private void initContactList() {
        ...
        contactList.setVisibleColumns([FNAME, LNAME, COMPANY].toArray());
    ...
    private static IndexedContainer createDummyDatasource() {
        ...
        String[] fnames = ["Peter", "Alice", "Joshua", "Mike", "Olivia", "Nina", "Alex", "Rita", "Dan",
                "Umberto", "Henrik", "Rene", "Lisa", "Marge"].toArray();
        String[] lnames = ["Smith", "Gordon", "Simpson", "Brown", "Clavel", "Simons", "Verne", "Scott",
                "Allison", "Gates", "Rowling", "Barks", "Ross", "Schneider", "Tate"].toArray();
